 ...
 * example 1:
 *
 * The instantiation of an object with no parameters Note the name of the class
 ...
 * obj = f.getObject( "com.patwolohan.Firefish.theClass" );
 *
...
public class Factory {
	...
	public Object createObject(String className, Object[] parameters, String[] parameterClassNames)
		...
		try {
			...
			theClass = Class.forName(className); // causes the class to be initialised
